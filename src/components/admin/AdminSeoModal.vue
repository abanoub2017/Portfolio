                ...
                <div
                    ...
                    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-800 shrink-0">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-xs mt-0.5">Manage page title, meta description and social sharing</p>
                            </div>
                        </div>
                    ...
                    <div class="overflow-y-auto px-6 py-5 flex flex-col gap-5">
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <p class="text-xs text-gray-600">Appears in the browser tab and Google results. Aim for 50–60 characters.</p>
                        </div>
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input v-model="form.keywords" type="text"
                                ...
                                class="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-indigo-500 transition-colors" />
                            <p class="text-xs text-gray-600">Comma-separated. Meta keywords have minimal ranking impact but are used in JSON-LD.</p>
                        </div>
                        ...
                        <div class="border-t border-gray-800 pt-1">
                            <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-4">Social Sharing</p>
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <input v-model="form.ogImage" type="url"
                                    ...
                                    class="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-indigo-500 transition-colors" />
                                <p class="text-xs text-gray-600">Shown when your link is shared on Twitter, LinkedIn, etc. Ideal size: 1200 × 630 px.</p>
                                <!-- Image preview -->
                                <div v-if="form.ogImage" class="mt-1 rounded-xl overflow-hidden border border-gray-700 aspect-video bg-gray-800 flex items-center justify-center">
                                    <img :src="form.ogImage" alt="OG image preview"
