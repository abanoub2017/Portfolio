...
<template>
    <div class="flex flex-col min-h-0">
        ...
        <div class="mb-6 flex items-center justify-between gap-4 flex-wrap">
            ...
            <RouterLink v-if="isEdit && postId" :to="{ name: 'admin-blog-preview', params: { id: postId } }"
                target="_blank"
                class="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium border border-gray-700 text-gray-300 hover:border-indigo-500 hover:text-white transition-all">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"
                    aria-hidden="true">
